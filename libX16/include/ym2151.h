...
#define YMCHIP (*(volatile struct __YM2151 *)0x9f40)
...
#define YMREG(registr,value) YMCHIP.reg = registr; __asm__ ("nop"); __asm__ ("nop"); __asm__ ("nop"); __asm__ ("nop"); YMCHIP.data = value;
